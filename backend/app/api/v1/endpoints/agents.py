...
from app.schemas.agent import (
    AgentDecisionExecutionRequest,
    AgentDecisionFilter,
    AgentDecisionRequest,
    AgentDecisionResponse,
    AgentDecisionStats,
    AgentDecisionValidationRequest,
    ...
    try:
        ...
        result = await db.execute(
            ...
            .where(
                ...
                (
                    AgentDecision.input_type == InputType.REVIEW
                    if request.input_type == "review"
                    else InputType.SUPPORT_TICKET
                ),
...
async def get_agent_decisions(
    ...
    if decision_type:
        try:
            ...
            raise HTTPException(
                status_code=status.HTTP_400_BAD_REQUEST, detail="Invalid decision type"
            )
...
async def get_agent_decision(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST, detail="Invalid decision ID format"
        )

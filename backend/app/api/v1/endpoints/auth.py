...
async def register(
    registration_data: UserRegistration, db: AsyncSession = Depends(get_async_db)
):
    """
...
async def refresh_token(
    refresh_data: RefreshTokenRequest, db: AsyncSession = Depends(get_async_db)
):
    """
...
async def confirm_password_reset(
    reset_data: PasswordResetConfirm, db: AsyncSession = Depends(get_async_db)
):
    """

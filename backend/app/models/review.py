...
class Review(Base):
    ...
    requires_private_recovery = Column(
    ...
    def __repr__(self):
        return (
            f"<Review(id={self.id}, platform='{self.platform}', rating={self.rating})>"
        )
    ...
    def is_critical(self) -> bool:
        ...
        return self.rating <= 2 and self.urgency_level == UrgencyLevel.HIGH
    ...
    def to_dict(self):
        ...
        return {
            ...
            "issue_categories": (
                [cat.value for cat in self.issue_categories]
            ...
            "public_response_date": (
                self.public_response_date.isoformat()
                if self.public_response_date
                else None
            ),

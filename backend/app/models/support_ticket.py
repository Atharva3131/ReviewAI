...
from sqlalchemy import Column, String, DateTime, Text, ForeignKey, Enum, DECIMAL, Integer
...
class SupportTicket(Base):
    ...
    def to_dict(self):
        ...
        return {
            ...
            "escalation_risk": float(self.escalation_risk) if self.escalation_risk else None,
            ...
            "time_to_first_response": round(self.time_to_first_response, 2) if self.time_to_first_response else None,
            "time_to_resolution": round(self.time_to_resolution, 2) if self.time_to_resolution else None
        }

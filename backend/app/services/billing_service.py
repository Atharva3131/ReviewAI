...
class BillingService:
    ...
    def create_subscription(
        self, organization_id: str, subscription_data: SubscriptionCreate
    ) -> Subscription:
    ...
    def cancel_subscription(
        self, subscription_id: str, organization_id: str, immediate: bool = False
    ) -> Subscription:
        """Cancel subscription"""
        subscription = (
            self.db.query(Subscription)
    ...
    def create_checkout_session(
        self, organization_id: str, checkout_data: CheckoutSessionCreate
    ) -> Dict[str, str]:
    ...
    def create_billing_portal_session(
        self, organization_id: str, portal_data: BillingPortalSessionCreate
    ) -> Dict[str, str]:
    ...
    def _handle_checkout_completed(self, data: Dict[str, Any]) -> None:
        ...
        if not subscription:
            subscription_data = SubscriptionCreate(
                plan_id=plan_id, billing_period=billing_period
            )
    ...
    def _handle_subscription_updated(self, data: Dict[str, Any]) -> None:
        ...
        if subscription:
            subscription.status = SubscriptionStatus(
                stripe_subscription.get("status", "active")
            )
    ...
    def _handle_invoice_paid(self, data: Dict[str, Any]) -> None:
        ...
        if subscription:
            ...
            invoice = (
                ...
                .filter(Invoice.stripe_invoice_id == stripe_invoice.get("id"))
                .first()
            )
    ...
    def record_usage(
        self, organization_id: str, usage_data: UsageRecordCreate
    ) -> UsageRecord:
    ...
    def check_usage_limits(self, organization_id: str) -> Dict[str, Any]:
        ...
        for metric, limit in limits.items():
            ...
            if current_usage > limit:
                violations.append(
                    {"metric": metric, "limit": limit, "current": current_usage}
                )

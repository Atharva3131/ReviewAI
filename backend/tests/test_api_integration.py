...
class TestAPIIntegration:
    ...
    def mock_auth_service(self):
        ...
        with patch('app.services.auth_service.AuthService') as mock:
            mock.create_tokens = AsyncMock(return_value={
...
class TestAuthenticationAPI(TestAPIIntegration):
    ...
    async def test_get_current_user(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_user: User):
    ...
    async def test_token_refresh(self, async_client: AsyncClient, test_user: User, test_organization: Organization):
...
class TestReviewsAPI(TestAPIIntegration):
    ...
    async def test_ingest_review(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        ...
        response = await async_client.post("/api/v1/reviews/ingest", json=review_data, headers=auth_headers)
    ...
    async def test_analyze_review(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_review: Review):
        """Test review analysis endpoint"""
        analysis_request = {"review_id": str(test_review.id)}
        
        response = await async_client.post("/api/v1/reviews/analyze", json=analysis_request, headers=auth_headers)
    ...
    async def test_get_reviews(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_review: Review):
        ...
        response = await async_client.get(
            "/api/v1/reviews/?platform=google&rating_min=4", 
    ...
    async def test_get_review_by_id(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_review: Review):
        """Test getting specific review by ID"""
        response = await async_client.get(f"/api/v1/reviews/{test_review.id}", headers=auth_headers)
    ...
    async def test_generate_review_response(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_review: Review):
        ...
        response = await async_client.post("/api/v1/reviews/respond", json=response_request, headers=auth_headers)
    ...
    async def test_review_stats(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_review: Review):
        """Test review statistics endpoint"""
        response = await async_client.get("/api/v1/reviews/stats/overview", headers=auth_headers)
...
class TestDashboardAPI(TestAPIIntegration):
    ...
    async def test_get_dashboard_metrics(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
    ...
    async def test_get_kpis_only(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test KPIs-only endpoint"""
        response = await async_client.get("/api/v1/dashboard/kpis", headers=auth_headers)
    ...
    async def test_get_activity_feed(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test activity feed endpoint"""
        response = await async_client.get("/api/v1/dashboard/activity?limit=5", headers=auth_headers)
    ...
    async def test_get_metrics_trends(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test metrics trends endpoint"""
        response = await async_client.get("/api/v1/dashboard/trends?time_range=7d", headers=auth_headers)
    ...
    async def test_dashboard_alerts(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test dashboard alerts endpoint"""
        response = await async_client.get("/api/v1/dashboard/alerts", headers=auth_headers)
    ...
    async def test_refresh_dashboard_cache(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test dashboard cache refresh endpoint"""
        response = await async_client.post("/api/v1/dashboard/metrics/refresh", headers=auth_headers)
...
class TestCustomersAPI(TestAPIIntegration):
    ...
    async def test_get_customers(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_customer: Customer):
    ...
    async def test_get_at_risk_customers(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test getting at-risk customers"""
        response = await async_client.get("/api/v1/customers/?at_risk_only=true", headers=auth_headers)
    ...
    async def test_get_customer_risk(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_customer: Customer):
        """Test customer risk assessment endpoint"""
        response = await async_client.get(f"/api/v1/customers/{test_customer.id}/risk", headers=auth_headers)
    ...
    async def test_recover_customer(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_customer: Customer):
        ...
        response = await async_client.post("/api/v1/customers/recover", json=recovery_request, headers=auth_headers)
    ...
    async def test_get_customer_recovery_actions(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_customer: Customer):
        """Test getting customer recovery actions"""
        response = await async_client.get(f"/api/v1/customers/{test_customer.id}/recovery-actions", headers=auth_headers)
    ...
    async def test_batch_risk_update(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test batch risk score update"""
        response = await async_client.post("/api/v1/customers/batch-risk-update", headers=auth_headers)
...
class TestAgentsAPI(TestAPIIntegration):
    ...
    async def test_agent_decide_action(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_review: Review):
        ...
        response = await async_client.post("/api/v1/agents/decide-action", json=decision_request, headers=auth_headers)
    ...
    async def test_get_agent_decisions(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test getting agent decisions list"""
        response = await async_client.get("/api/v1/agents/decisions", headers=auth_headers)
        
        assert response.status_code == 200
        data = response.json()
        assert isinstance(data, list)
    
    async def test_get_agent_decision_by_id(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_review: Review):
        ...
        create_response = await async_client.post("/api/v1/agents/decide-action", json=decision_request, headers=auth_headers)
        decision_id = create_response.json()["decision_id"]
        
        # Then get it by ID
        response = await async_client.get(f"/api/v1/agents/decisions/{decision_id}", headers=auth_headers)
        
        assert response.status_code == 200
        data = response.json()
        assert data["id"] == decision_id
    
    async def test_get_decision_rules_summary(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test getting decision rules summary"""
        response = await async_client.get("/api/v1/agents/rules/summary", headers=auth_headers)
...
class TestUsersAPI(TestAPIIntegration):
    ...
    async def test_get_users(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_user: User):
    ...
    async def test_get_user_by_id(self, async_client: AsyncClient, auth_headers: Dict[str, str], test_user: User):
    ...
    async def test_create_user(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
    ...
    async def test_get_organization_user_stats(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test getting organization user statistics"""
        response = await async_client.get("/api/v1/users/organization/stats", headers=auth_headers)
...
class TestWebhooksAPI(TestAPIIntegration):
    ...
    async def test_google_reviews_webhook(self, async_client: AsyncClient):
        ...
        response = await async_client.post("/api/v1/webhooks/google-reviews", json=webhook_data)
    ...
    async def test_generate_test_google_review(self, async_client: AsyncClient):
        ...
        response = await async_client.post("/api/v1/webhooks/google-reviews/test?rating=3&content=Test review")
    ...
    async def test_crm_webhook_endpoints(self, async_client: AsyncClient):
        ...
        response = await async_client.post("/api/v1/webhooks/crm/customer-updated", json=customer_webhook_data)
        assert response.status_code == 200
        ...
        response = await async_client.post("/api/v1/webhooks/crm/support-ticket", json=ticket_webhook_data)
        assert response.status_code == 200
...
class TestMultiTenantIsolation(TestAPIIntegration):
    ...
    @pytest.fixture
    async def second_user(self, db_session: AsyncSession, second_organization: Organization):
    ...
    @pytest.fixture
    async def second_auth_headers(self, second_user: User, second_organization: Organization):
    ...
    async def test_review_isolation(self, async_client: AsyncClient, auth_headers: Dict[str, str], 
                                  second_auth_headers: Dict[str, str], test_review: Review):
        ...
        response = await async_client.get("/api/v1/reviews/", headers=second_auth_headers)
        assert response.status_code == 200
    ...
    async def test_customer_isolation(self, async_client: AsyncClient, auth_headers: Dict[str, str],
                                    second_auth_headers: Dict[str, str], test_customer: Customer):
        ...
        response = await async_client.get("/api/v1/customers/", headers=second_auth_headers)
        assert response.status_code == 200
    ...
    async def test_dashboard_metrics_isolation(self, async_client: AsyncClient, auth_headers: Dict[str, str],
                                             second_auth_headers: Dict[str, str]):
        """Test that dashboard metrics are isolated between organizations"""
        # Get metrics for first organization
        response1 = await async_client.get("/api/v1/dashboard/metrics", headers=auth_headers)
        assert response1.status_code == 200
        org1_metrics = response1.json()
        
        # Get metrics for second organization
        response2 = await async_client.get("/api/v1/dashboard/metrics", headers=second_auth_headers)
...
class TestErrorHandling(TestAPIIntegration):
    ...
    async def test_invalid_review_id(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test handling of invalid review ID"""
        invalid_id = str(uuid.uuid4())
        response = await async_client.get(f"/api/v1/reviews/{invalid_id}", headers=auth_headers)
        
        assert response.status_code == 404
        assert "not found" in response.json()["detail"].lower()
    
    async def test_invalid_customer_id(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test handling of invalid customer ID"""
        invalid_id = str(uuid.uuid4())
        response = await async_client.get(f"/api/v1/customers/{invalid_id}/risk", headers=auth_headers)
        
        assert response.status_code == 404
        assert "not found" in response.json()["detail"].lower()
    
    async def test_malformed_request_data(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        ...
        response = await async_client.post("/api/v1/reviews/ingest", json=invalid_review_data, headers=auth_headers)
        
        assert response.status_code == 422  # Validation error
    
    async def test_invalid_query_parameters(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test handling of invalid query parameters"""
        # Invalid time range
        response = await async_client.get("/api/v1/dashboard/metrics?time_range=invalid", headers=auth_headers)
        
        assert response.status_code == 422  # Validation error
    
    async def test_rate_limiting_headers(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
...
class TestPerformanceAndCaching(TestAPIIntegration):
    ...
    async def test_dashboard_metrics_caching(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        ...
        start_time = datetime.utcnow()
        response2 = await async_client.get("/api/v1/dashboard/metrics", headers=auth_headers)
    ...
    async def test_pagination_performance(self, async_client: AsyncClient, auth_headers: Dict[str, str]):
        """Test pagination performance with different limits"""
        # Test small page size
        response = await async_client.get("/api/v1/reviews/?limit=10", headers=auth_headers)
        assert response.status_code == 200
        
        # Test larger page size
        response = await async_client.get("/api/v1/reviews/?limit=100", headers=auth_headers)
        assert response.status_code == 200
        
        # Test maximum page size
        response = await async_client.get("/api/v1/reviews/?limit=1000", headers=auth_headers)
        assert response.status_code == 200

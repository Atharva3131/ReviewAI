...
class TestSupportTicketAPI:
    ...
    async def test_create_ticket(
        ...
        response = await async_client.post(
            "/api/v1/support-tickets/", json=ticket_data, headers=auth_headers
        )
    ...
    async def test_list_tickets(
        ...
        response = await async_client.get(
            "/api/v1/support-tickets/", headers=auth_headers
        )
    ...
    async def test_update_ticket(
        ...
        update_data = {"subject": "Updated subject", "priority": "high"}
    ...
    async def test_assign_ticket(
        ...
        assign_data = {"assigned_to": "agent_123"}
    ...
    async def test_analyze_ticket(
        ...
        analyze_data = {"ticket_id": str(ticket.id)}

        response = await async_client.post(
            "/api/v1/support-tickets/analyze", json=analyze_data, headers=auth_headers
        )
    ...
    async def test_get_ticket_stats(
        ...
        response = await async_client.get(
            "/api/v1/support-tickets/stats", headers=auth_headers
        )
